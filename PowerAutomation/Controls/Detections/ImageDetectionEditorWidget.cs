...
{
    public partial class ImageDetectionEditorWidget : Widget, IEditControl<ImageDetection>
    {
        private string autoKey = string.Empty;

        public ImageDetectionEditorWidget(ApplicationInformation appInfo, ImageDetection model) : base("Detection Task")
        {
            AppInfo = appInfo;
            Model = model;
            InitializeComponent();
